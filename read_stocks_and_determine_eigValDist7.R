...
plot(LambdaOptim2 , RhosOptim2, type='l',col='blue', xlim = c(minX, maxX),ylim=c(minY,maxY),ylab="",xlab="")


#par(new=TRUE)	# do not clean drawing area

#plot(mids , RhosOptim, type='o',col='green', xlim = c(minX, maxX),ylim=c(minY,maxY),ylab="",xlab="")
