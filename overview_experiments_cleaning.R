...
plot(Tcov,sigCleaning,type='l',lwd=2,ylim=c(minY,maxY),main="Volatility of Portfolio as function of Tcov",ylab="Vol.",xlab="Tcovariance")
...
legend("topright", legend = c("Cleaning", "Trew=5", "in sample", "1/N"), col = c('black','red','green', 'green'),lwd = c(2,2,2,2),lty = c('solid', 'solid', 'twodash','twodash'), merge = TRUE)
